"""
pytest 风格测试 - 里程碑：真龙之心（龙心谷终音法器，龙性资源 + 8种龙族特性）

原文：
"每消耗12X龙性，获得X种不同龙族特性（6X衰老=2X枯竭=X萎缩=12X龙性）"。
8种特性：龙族血脉/龙威/龙族利爪/龙息/震岳龙躯/吞骸龙胃/断尾求生/烬翼。

覆盖范围：pay_for_dragon_nature/unlock_dragon_trait 的门槛与汇率校验 + 8种特性各自的机制效果。
运行方式：
...
def test_unlock_dragon_trait_requires_12_nature_and_rejects_duplicates():
    """边界+错误输入：解锁1种特性消耗12龙性；龙性不足/未知特性/重复解锁均应拒绝"""
...
def test_tail_sacrifice_error_declare_self_or_unowned_trait():
    """错误输入：不能声明牺牲自身(断尾求生)，也不能声明未持有的其他特性"""
