...
class ResonanceEngine:
    ...
    # 闭环结构定义（忠实转录 README 原文）
    # 通用双环：README「道纹网络」杀伐闭环（480行）、锐利闭环（490行）
    # 怪物分支：README「怪物转化道纹」501-525行，原始→转化单向，不可逆向
    #   （必中、飞行原文没有曲解分支，查询自然返回"路径不存在"，残韵不消耗）
    # 副本闭环：README 扭曲都市（638行）、罪孽都市（729行）、龙心谷（811行）
    CLOSED_LOOPS = {
        "杀伐闭环": [
            ("杀伐", "反转", "再生"),
            ("再生", "曲解", "庇护"),
        ...
        "怪物转化分支": [
            # 原始怪物道纹 → 转化道纹（单向，README 262行规则2）
            ("狂暴", "转换", "愤怒"), ("狂暴", "反转", "自残"), ("狂暴", "曲解", "无神"),
            ("强化", "转换", "借力"), ("强化", "反转", "弱化"), ("强化", "曲解", "自食"),
            ("活力", "转换", "兴奋"), ("活力", "反转", "无力"), ("活力", "曲解", "迟滞"),
            ("减速", "转换", "急速"), ("减速", "反转", "加速"), ("减速", "曲解", "眩晕"),
            ("必中", "转换", "洞察"), ("必中", "反转", "蒙蔽"),
            ("自愈", "转换", "滋养"), ("自愈", "反转", "衰败"), ("自愈", "曲解", "寄生"),
            ("飞行", "转换", "滑翔"), ("飞行", "反转", "坠落"),
        ],
        "扭曲都市闭环": [
            ("变形", "转换", "定型"), ("定型", "反转", "畸变"), ("畸变", "曲解", "僵化"),
            ("僵化", "转换", "超频"), ("超频", "反转", "坏死"), ("坏死", "曲解", "爆裂"),
            ("爆裂", "曲解", "退化"), ("退化", "转换", "变形"),
        ],
        "罪孽都市闭环": [
            ("洗劫", "转换", "逼债"), ("逼债", "反转", "抵扣"), ("抵扣", "曲解", "清算"),
            ("清算", "反转", "赎金"), ("赎金", "转换", "假钞"), ("假钞", "曲解", "赌命"),
            ("赌命", "反转", "消灾"), ("消灾", "曲解", "洗劫"),
        ],
        "龙心谷闭环": [
            ("加害", "反转", "龙鳞"), ("龙鳞", "曲解", "逆鳞"), ("逆鳞", "转换", "活血"),
            ("活血", "曲解", "裂变"), ("裂变", "转换", "嫁祸"), ("嫁祸", "反转", "背负"),
            ("背负", "曲解", "伤痕"), ("伤痕", "转换", "加害"),
        ],
    }
