...
【自愈】【衰败】（ROUND_START 相位，priority 10/20）、【畸变·结算】（ROUND_END
相位，priority 10，锚定凡庸 tick 之前）、【焦黑发丝】（ENTITY_DIED 事件，首个生产
事件订阅者）、【帮派令】（BATTLE_START 相位 + relic_active 条件——证明 Relic
可以成为普通 Mechanism 声明）。
...
# 导入即注册已迁移机制（当前：加害、龙鳞、自愈、帮派令、衰败、畸变·结算、焦黑发丝）。
