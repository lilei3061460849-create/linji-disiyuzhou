...
# 敌方身上值得用残韵改写的高价值道纹。
# 注意：残韵闭环(ResonanceEngine.CLOSED_LOOPS)目前只登记了杀伐/锐利两条主轨，
# 怪物原始道纹(必中/狂暴/飞行等)尚无变化路径，对其发动必然失败，
# 故此处只列**确实存在残韵路径**的道纹，按威胁度排序。
HIGH_VALUE_ENEMY_DAOWEN = ["贯穿", "血债", "冲击", "杀伐", "增殖", "透支",
                           "固执", "庇护", "再生", "锐利", "缓慢", "束缚"]
