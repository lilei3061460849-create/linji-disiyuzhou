...
"真龙之心"解锁后进入独立的龙性资源/8特性系统（`GameEngine.DRAGON_NATURE_RATE`/`DRAGON_TRAITS`）。
...
| `unlock_dragon_trait` | 真龙之心：花12龙性解锁1种龙族特性(trait) |
| `activate_dragon_body` | 震岳龙躯：花6X龙性，激活X回合的15点伤害上限护体 |
| `devour_monster` | 吞骸龙胃：吞噬已命零的怪物，回复12+可选龙心+6耐久 |
| `declare_tail_sacrifice` | 断尾求生：预声明命零时愿意移除的其他龙族特性 |
