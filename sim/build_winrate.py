#!/usr/bin/env python3
"""
流派胜率对比：测试不同道纹组合（杀伐系 / 波及系 / 各副本专属）的实战表现。
...
用法：
    ...
    python3 sim/build_winrate.py --build 波及系      # 只测一个流派
...
BUILDS: dict[str, dict] = {
    "杀伐系":   {"learn": ["庇护", "再生", "波及", "血债", "束缚"]},
    "波及系":   {"learn": ["波及", "贯穿", "透支", "束缚", "封印", "增殖"]},
    # 2026-08-21：冲击改名波及；缓慢/慈悲/切割已删除。
