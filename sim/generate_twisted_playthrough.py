...
def run_twisted_playthrough():
    ...
    d_lines.append("  [受伤害前反噬] 莫非处于【爆裂】！林渊造成伤害前瞬间受到 12 点反噬伤害；【岩行者】发动【背负1】替主承伤12点（岩行者生命 54→42）！")
    ...
    d_lines.append("  [受伤害前反噬] 莫非【爆裂2】反噬30点伤害；【岩行者】发动【背负1】替主承受30点反噬（岩行者生命 42→12）！")
